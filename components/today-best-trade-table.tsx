        ...
        <div className="w-full sm:w-auto flex justify-end"> {/* Container for the button, ensures full width on small and right alignment on medium+ */}
          <Sheet open={isEditSheetOpen} onOpenChange={setIsEditSheetOpen}>
            <SheetTrigger asChild>
              <Button variant="outline" size="sm" disabled={loading} className="w-full sm:w-auto"> {/* Full width on small, auto on medium+ */}
      ...
      <CardContent className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-sm pt-4"> {/* Adjusted grid for better spacing */}
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col col-span-2 sm:col-span-3 md:col-span-4"> {/* Ensured it spans full width if needed */}
